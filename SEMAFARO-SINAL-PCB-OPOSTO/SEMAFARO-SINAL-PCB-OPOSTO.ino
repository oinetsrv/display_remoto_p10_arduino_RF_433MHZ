...
// === --- Protótipo das Funções --- ===============================================
  ...
  void seta_subir_2();  // acende leds vm1 e vd 2
  void seta_descer_2(); // acende leds vm2 e vd 1
  void pare_X();     // acende todos leds vermelhos
  void off_X();     // acende todos leds vermelhos

// === --- Variáveis Globais --- ===================================================
  // --- Variáveis Globais ---
  int cont=0,cont1=0,cont3=0,cont4=0,cont5=0; // vairiavel que conta quantas vezes precionado botao 3
...
// === --- Configurações Iniciais --- ==============================================
  ...
  void setup() {
      ...
      Serial.print("SEMAFARO-SINAL-PCB-OPOSTO");
      Serial.println(" ");
...
// === --- Loop Infinito --- =======================================================
 ...
 // === readKey =====================================================================
    void readKey() {
        ...
        if (digitalRead(bt1)) {
          if (flag4 == 1 && cont1 == 0 ) {
                Serial.println("SETA DESCER!  "); // debug via serial
                delay(25);
                //seta_descer();
                seta_subir();
                cont1 = 1;
