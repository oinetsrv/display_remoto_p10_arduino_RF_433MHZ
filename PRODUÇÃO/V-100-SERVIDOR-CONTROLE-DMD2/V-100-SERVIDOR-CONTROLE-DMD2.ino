...
void setup() {
    ...
    dmd.begin();
    Serial.println("V-100-SERVIDOR-CONTROLE-MONO-DMD2:");
...
void loop() {
    ...
    if (currentMillis - startMillis >= period){
        ...
        //currentMillis = millis(); 
        dmd.setPixel(x + 3, m_y_I_d_c + 3 , GRAPHICS_OFF);
    }
...
void digito() {
    ...
    //currentMillis = millis();
    startMillis = currentMillis;
    dmd.setPixel(x + 3, m_y_I_d_c + 3 , GRAPHICS_ON);
