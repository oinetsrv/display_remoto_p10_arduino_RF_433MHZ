/* === APRESENTAÇÃO: ===============================================================
  Projeto: Display posto de combustível
  ...
  Descrição do projeto:
     Servidor com 6 displays em serie.
     Cliente com 3 displays em serie, não consegui colocar todos os displays
     com um unico controlador. Incrementação do valor e seleção do digito via rádio.
